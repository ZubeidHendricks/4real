...
These tests should be run sequentially through the 4real chat interface in Unreal Engine. Each test builds on the previous ones. Check to see if assets exist before creating them. Delete them if they already exist, then create them if needed.
