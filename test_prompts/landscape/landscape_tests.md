...
Recreate `/Game/Stylized_Spruce_Forest/Materials/Master_Materials/M_Landscape` as `M_Landscape2` using only 4real landscape material tools — zero asset duplication. Every expression, connection, property, parameter, function call, HLSL node, and material output must be reproduced exactly.
