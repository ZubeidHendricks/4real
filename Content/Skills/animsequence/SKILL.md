...
> there is no `4real-skills-manager` tool. Run the 4real services below with `execute_python_code`
...
> **🛡️ SAFE DISCOVERY: Always use 4real service methods**
>
...
**Safe alternatives:**
1. **USE 4real's `FindAnimationsForSkeleton()` - BEST OPTION**
...
**BEST: Use 4real AnimSequenceService methods**
```python
# CORRECT - 4real safe discovery (no loading)
import unreal
