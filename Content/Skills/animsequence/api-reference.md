...
> **Default Output Folder:** `Saved/4real/Screenshots/<AnimationName>/`
> 
...
# Pass "" for output_path to use default: Saved/4real/Screenshots/<AnimName>/pose_<time>.png
result = AnimSequenceService.capture_animation_pose(
    ...
    output_path,        # str - Output PNG path ("" = auto in Saved/4real/Screenshots/)
...
# Pass "" for output_directory to use default: Saved/4real/Screenshots/<AnimName>/
results = AnimSequenceService.capture_animation_sequence(
    anim_path,          # str - Animation asset path  
    output_directory,   # str - Directory for PNGs ("" = auto in Saved/4real/Screenshots/)
...
results = unreal.AnimSequenceService.capture_animation_sequence(
    ...
    "",                           # Empty = use default Saved/4real/Screenshots/AS_SwordSwing/
    5,                            # 5 frames
    "front",                      # Front view
    512, 512                      # Image size
)
