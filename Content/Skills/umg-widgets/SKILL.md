...
`Plugins/ForReal/Content/Skills/umg-widgets/` (the engine `AgentSkillToolset` `GetSkills` is the
loader that exposes this skill; there is no `4real-skills-manager` tool):
