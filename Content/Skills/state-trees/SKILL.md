...
Load the `blueprints` skill (via the engine `AgentSkillToolset` — `GetSkills`, see the `4real`
...
`AgentSkillToolset` (`GetSkills` with `["state-trees/<name>"]`, see the `4real` skill) when you need the detail:
