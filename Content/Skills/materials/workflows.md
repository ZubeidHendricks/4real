...
4real is an extension on Unreal's native MCP endpoint. **Material/function BASICS** (create
...
# 4real delta: parameter authoring stays on MaterialNodeService.
...
parameters at once, 4real keeps `ms.set_instance_parameters_bulk(...)`.
