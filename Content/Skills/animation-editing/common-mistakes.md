...
description: Animation editing pitfalls — always specify bone space, preview/validate before baking, analyze the reference pose before guessing axes, build a skeleton profile first, and never load assets in loops (crashes); use 4real safe-discovery methods.
---
...
# CORRECT — 4real safe discovery (queries metadata, no loading)
