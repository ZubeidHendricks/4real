...
FForRealMaterialFunctionInfo UMaterialNodeService::GetFunctionInfo(const FString& FunctionPath)
{
	FForRealMaterialFunctionInfo Info;
...
// Epic's native MaterialTools.delete_expression, so ForReal does not duplicate it. This covers
