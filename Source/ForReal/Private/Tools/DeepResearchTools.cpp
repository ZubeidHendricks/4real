...
static FResearchHttpResult ResearchHttpGet(
	const FString& Url,
	const FString& UserAgent = TEXT("ForReal/1.0 (Unreal Engine plugin)"),
...
static FString ActionSearch(const TMap<FString, FString>& Params)
{
	...
	const FResearchHttpResult Http = ResearchHttpGet(
		JinaUrl,
		TEXT("ForReal/1.0 (Unreal Engine plugin)"),
		Headers,
		20.0f);
...
static FString ActionGeocode(const TMap<FString, FString>& Params)
{
	...
	const FResearchHttpResult Http = ResearchHttpGet(Url, TEXT("ForReal/1.0 (Unreal Engine plugin)"), {}, 15.0f);
...
// Tool registration
// ---------------------------------------------------------------------------
REGISTER_FORREAL_TOOL(deep_research,
