...
FString UPythonTools::ConvertExecutionResultToJson(const ForReal::FPythonExecutionResult& Result)
{
...
FString UPythonTools::ConvertModuleInfoToJson(const ForReal::FPythonModuleInfo& Info)
{
	TSharedPtr<FJsonObject> JsonObj = MakeShared<FJsonObject>();
...
FString UPythonTools::ConvertClassInfoToJson(const ForReal::FPythonClassInfo& Info)
{
	TSharedPtr<FJsonObject> JsonObj = MakeShared<FJsonObject>();
	JsonObj->SetBoolField(TEXT("success"), true);
	...
	for (const ForReal::FPythonFunctionInfo& Method : Info.Methods)
	{
...
FString UPythonTools::ConvertFunctionInfoToJson(const ForReal::FPythonFunctionInfo& Info)
{
	TSharedPtr<FJsonObject> JsonObj = MakeShared<FJsonObject>();
	JsonObj->SetBoolField(TEXT("success"), true);
