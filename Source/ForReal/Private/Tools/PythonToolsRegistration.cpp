...
REGISTER_FORREAL_TOOL(execute_python_code,
...
REGISTER_FORREAL_TOOL(discover_python_module,
...
REGISTER_FORREAL_TOOL(discover_python_class,
...
REGISTER_FORREAL_TOOL(discover_python_function,
...
REGISTER_FORREAL_TOOL(list_python_subsystems,
