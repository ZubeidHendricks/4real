...
public class ForReal : ModuleRules
{
	public ForReal(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(
			new string[]
			{
				...
				"ModelContextProtocol",   // UE 5.8 native MCP server — ForReal's dynamic tools are bridged onto Epic's endpoint
			}
		);
