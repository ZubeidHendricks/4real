 ...
 */
struct FORREAL_API FPythonFunctionInfo
{
	/** Function name */
	FString Name;
 ...
 */
struct FORREAL_API FPythonClassInfo
{
	/** Class name */
	FString Name;
 ...
 */
struct FORREAL_API FPythonModuleInfo
{
 ...
 */
struct FORREAL_API FPythonExecutionResult
{
 ...
 */
struct FORREAL_API FPythonExampleScript
{
	/** Example title */
	FString Title;
 ...
 */
struct FORREAL_API FSourceSearchResult
{
