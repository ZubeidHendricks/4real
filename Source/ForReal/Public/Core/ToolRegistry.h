 ...
 */
struct FORREAL_API FToolRegistration
{
	FString Name;
	FString Description;
	FString Category;
	...
	/** If true, tool is only available to ForReal chat, not exposed via MCP */
 ...
 * Supports automatic registration via REGISTER_FORREAL_TOOL macro
 */
class FORREAL_API FToolRegistry
{
public:
	...
	/**
	 * Register a tool (called automatically by REGISTER_FORREAL_TOOL macro)
 ...
 */
struct FORREAL_API FToolAutoRegistrar
{
 ...
 * Usage: REGISTER_FORREAL_TOOL(tool_name, "Description", "Category", []() { return MyFunc(); })
 */
#define REGISTER_FORREAL_TOOL_SIMPLE(ToolName, Description, Category, Lambda) \
 ...
 * Usage in .cpp file:
 * 
 * REGISTER_FORREAL_TOOL(manage_level_actors,
 ...
 * );
 */
#define REGISTER_FORREAL_TOOL(ToolName, Description, Category, ParamList, ExecuteBody) \
	static FToolAutoRegistrar AutoRegister_##ToolName( \
		FToolRegistration{ \
			TEXT(#ToolName), \
			TEXT(Description), \
 ...
 * Use for tools that need direct access to ForReal chat session state.
 * 
 * Usage in .cpp file:
 * 
 * REGISTER_FORREAL_INTERNAL_TOOL(attach_image,
 ...
 * );
 */
#define REGISTER_FORREAL_INTERNAL_TOOL(ToolName, Description, Category, ParamList, ExecuteBody) \
	static FToolAutoRegistrar AutoRegister_##ToolName( \
		FToolRegistration{ \
			TEXT(#ToolName), \
			TEXT(Description), \
