...
class FORREAL_API UInputService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Input")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Input|Exists")
