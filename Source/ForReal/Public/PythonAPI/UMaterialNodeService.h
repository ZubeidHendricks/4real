 ...
 */
USTRUCT(BlueprintType)
struct FForRealMaterialFunctionInfo
{
	GENERATED_BODY()
...
struct FMaterialDiagnostics
{
	...
	UPROPERTY(BlueprintReadWrite, Category = "ForReal|Materials")
	bool bSuccess = false;
...
UCLASS()
class FORREAL_API UMaterialNodeService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 * silently returns 0.
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Get Material Diagnostics"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "MaterialNode")
	static FForRealMaterialFunctionInfo GetFunctionInfo(const FString& FunctionPath);
