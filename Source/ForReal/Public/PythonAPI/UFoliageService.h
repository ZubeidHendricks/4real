 ...
 */
USTRUCT(BlueprintType)
struct FForRealFoliageTypeInfo
{
	GENERATED_BODY()
...
class FORREAL_API UFoliageService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Foliage")
	static TArray<FForRealFoliageTypeInfo> ListFoliageTypes();
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Foliage|Exists")
