...
/**
 * Blend settings for a montage (ForReal wrapper)
 */
USTRUCT(BlueprintType)
...
class FORREAL_API UAnimMontageService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|Sections")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|Slots")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|Segments")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|Notifies")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|BranchingPoints")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|RootMotion")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|Creation")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Montage|Editor")
