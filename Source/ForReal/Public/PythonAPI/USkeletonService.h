...
class FORREAL_API USkeletonService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 *       print(path)
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Discovery")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Bones")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Modification")
	static bool AddBone(
		const FString& SkeletalMeshPath,
		const FString& BoneName,
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Retargeting")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Curves")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|BlendProfiles")
	 ...
	 *   )
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Properties")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Editor")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Skeleton|Profiles")
