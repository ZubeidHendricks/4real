...
/**
 * ForReal service for creating, inspecting, and editing StateTree assets.
...
class FORREAL_API UStateTreeService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|StateTree")
