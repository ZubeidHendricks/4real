...
/**
 * Material instance information (ForReal custom)
 */
USTRUCT(BlueprintType)
struct FForRealMaterialInstanceInfo
{
	GENERATED_BODY()
...
class FORREAL_API UMaterialService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Save Material"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Compile Material"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Refresh Material Editor"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Open Material In Editor"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Get Material Info"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Summarize Material"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "List Material Properties"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Get Material Property Info"))
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Set Material Property"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Set Material Properties"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "List Material Parameters"))
	 ...
	 *   )
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Materials", meta = (AICallable, DisplayName = "Set Instance Parameters Bulk"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Materials|Exists")
