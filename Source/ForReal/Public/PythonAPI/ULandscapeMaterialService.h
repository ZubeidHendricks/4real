...
class FORREAL_API ULandscapeMaterialService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|LandscapeMaterial")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|LandscapeMaterial|Exists")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|LandscapeMaterial|AutoMaterial")
