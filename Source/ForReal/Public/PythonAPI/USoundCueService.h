...
struct FSoundCueResult
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "ForReal|Audio")
	bool bSuccess = false;
...
class FORREAL_API USoundCueService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|Lifecycle")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|Inspection")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|Nodes")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|Connections")
	 ...
	 *   print(val)  # "0.95"
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|NodeProperties")
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|Settings")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Audio|SoundWave")
