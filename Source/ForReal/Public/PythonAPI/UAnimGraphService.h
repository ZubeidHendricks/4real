...
class FORREAL_API UAnimGraphService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Navigation")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Introspection")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Assets")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Utility")
	 ...
	 *   )
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|StateMachine")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|TransitionRules")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|StateAuthoring")
	 ...
	 *   )
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Animation|Connections")
