...
class FORREAL_API ULandscapeService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Landscape")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Landscape|Exists")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Landscape|Painting")
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Landscape|Holes")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|Landscape|Splines")
