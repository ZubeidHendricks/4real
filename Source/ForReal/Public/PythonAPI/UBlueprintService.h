...
/**
 * Snapshot of the graph the user is currently looking at — ForReal's equivalent of
...
class FORREAL_API UBlueprintService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Blueprints")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Blueprints|Components")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Blueprints|Functions")
	 ...
	 *
	 * ForReal's analogue of Epic's UAIAssistantToolset::GetDockedContext(). Epic
	 * anchors on the AI assistant's own docked widget; ForReal has no in-editor
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Blueprints|Nodes")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Blueprints|Exists")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Blueprints|BatchGraph")
