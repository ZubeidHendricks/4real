 ...
 *
 * IMPORTANT: Most ForReal service edits already wrap themselves in their own transactions,
...
class FORREAL_API UTransactionService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Transactions")
	static bool Undo();
