...
/**
 * Procedural FPS-map blockout generator. Reads weight layers from a ForReal-generated
...
/**
 * UMapBlockoutService — procedural FPS-map blockout from a ForReal landscape.
 *
...
class FORREAL_API UMapBlockoutService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category ="ForReal|MapBlockout")
