...
class FORREAL_API UNiagaraEmitterService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|NiagaraEmitter", meta = (AICallable, DisplayName = "Set Color Tint"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|NiagaraEmitter", meta = (AICallable, DisplayName = "Get Color Curve Keys"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|NiagaraEmitter", meta = (AICallable, DisplayName = "Set Color Curve Keys"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|NiagaraEmitter", meta = (AICallable, DisplayName = "Shift Color Hue"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|NiagaraEmitter", meta = (AICallable, DisplayName = "Get Rapid Iteration Parameters"))
