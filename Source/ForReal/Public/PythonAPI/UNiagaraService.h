...
class FORREAL_API UNiagaraService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Niagara|Diagnostics", meta = (AICallable, DisplayName = "Compare Systems"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Niagara|Diagnostics", meta = (AICallable, DisplayName = "List Rapid Iteration Params"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Niagara|Diagnostics", meta = (AICallable, DisplayName = "Set Rapid Iteration Param"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Niagara|Diagnostics", meta = (AICallable, DisplayName = "Set Rapid Iteration Param By Stage"))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Niagara|Diagnostics", meta = (AICallable, DisplayName = "Get Emitter Lifecycle"))
	 ...
	 *   print(debug_info)
	 */
	UFUNCTION(BlueprintCallable, Category = "ForReal|Niagara|Diagnostics", meta = (AICallable, DisplayName = "Debug Activation"))
