...
class FORREAL_API UWidgetService : public UToolsetDefinition
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets")
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|Font")
	static bool SetFont(
		const FString& WidgetPath,
		const FString& ComponentName,
	 ...
	 * @return True if successful
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|Brush")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|Animation")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|Preview")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|PIE")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|ViewModel")
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta = (AICallable), Category = "ForReal|Widgets|Exists")
